    ...
    itens: [
      {
        ...
        resposta: "Sim! Em qualquer formulário (Compra, Recompra, Proposta ou Ocorrência), você pode clicar no botão <strong>'Salvar formulário'</strong> (botão cinza secundário). Isso criará um rascunho que será armazenado. Você pode acessá-lo depois no menu <strong>'Formulários Salvos'</strong>. Lá você verá o prazo de expiração (que é de <strong>7 dias úteis</strong>) e poderá clicar em 'Recuperar' para voltar exatamente de onde parou.",
      },
      {
      ...
      },
      {
        ...
        resposta: "Os rascunhos têm validade de 7 dias úteis (dias da semana, excluindo fins de semana e feriados). Após esse período, o rascunho é automaticamente removido do sistema. Lembre-se de finalizar ou recuperar seus rascunhos periodicamente.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    itens: [
      ...
      },
      {
        ...
        resposta: "Clique em <strong>'Formulários Salvos'</strong> no menu. Lá você verá uma lista com todos os rascunhos que você salvou, a data de salvamento, o tipo de formulário e quanto tempo falta para expirar (7 dias úteis).",
      },
      {
