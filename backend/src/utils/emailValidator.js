...
export const isValidEmail = (email) => {
  ...
  // Deve ter: caracteres não-espaço @ caracteres não-espaço . caracteres não-espaço
...
export const validateAndSanitizeEmail = (email) => {
  ...
  // Verifica se domínio tem pelo menos 2 caracteres após o ponto final
  ...
  if (tld.length < 2) {
    return {
      isValid: false,
      value: trimmed,
      error: "Domínio deve ter uma extensão válida (ex: .com, .br, .net)",
    };
  }
