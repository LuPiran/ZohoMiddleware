...
export const ENV = {
  ...
  // Consultor escolhe "encaminhar pro MKT" em vez de ir pra Compra — status
  // próprio, para não misturar com "Lead Com Interesse". Nome do campo no
  // Zoho já criado como "DataLead_Qualificado" (não precisou trocar lá).
  ZOHO_LEAD_DATA_ENCAMINHADO_MKT_FIELD:
    process.env.ZOHO_LEAD_DATA_ENCAMINHADO_MKT_FIELD || "DataLead_Qualificado",
